    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex h-[400px] gap-4">
        <div className=" w-full">
          ...
          <div className=" p-4">
            <p className="gray-text-md">Recipient Email</p>
            <p className="gray-text-lg">abchaudhry1197@gmail.com</p>
          </div>
          <div className="bg-[#D8D8D833] p-4">
            <p className="gray-text-md">Name on Card</p>
            <p className="gray-text-lg">usama Chattha</p>
          </div>
          <div className=" p-4">
            <p className="gray-text-md">Card</p>
            <p className="gray-text-lg">**** **** **** 5656</p>
          </div>
          <div className="bg-[#D8D8D833] p-4">
            <p className="gray-text-md">Description</p>
            <p className="gray-text-lg">asdf</p>
          </div>
        </div>
        <div className=" w-full bg-white rounded-lg shadow-md p-4">
          ...
          <div>
            ...
            <div className="bg-[#D8D8D833] p-4 flex justify-between h-[60px] rounded-lg items-center">
              <p className="gray-text-sm">Instant Pay Amount</p>
              <p>$1.00</p>
            </div>
            <div className=" p-4 flex justify-between h-[60px] items-center">
            ...
            <div className="bg-[#D8D8D833] p-4 flex justify-between h-[60px] rounded-lg items-center border-r-8 border-[#35bab6]">
...
export default ConfirmInstantPayForm;
